    ...
    init: function() {
        ...
        animatedMarker.addEventListener('mousedown', function(ev, target){
            ...
            if (aEntity && intersectedElement === aEntity) {
				...
				aEntity.setAttribute('animation', {property: 'position', dur: 1000, to: '0 0.5 0', direction: 'alternate'});					
				alert("Yellow");
            }
            if (aEntity2 && intersectedElement === aEntity2) {
				aEntity2.setAttribute('animation', {property: 'rotation', dur: 3000, to: '0 360 0', loop: true});
				aEntity2.setAttribute('animation', {property: 'position', dur: 1000, to: '0 0.5 0', direction: 'alternate'});					
				alert("Blue");
